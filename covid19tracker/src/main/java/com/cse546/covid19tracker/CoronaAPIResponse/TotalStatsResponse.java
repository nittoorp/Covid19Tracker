package com.cse546.covid19tracker.CoronaAPIResponse;
...
public class TotalStatsResponse {
	 ...
	 * @param new_deaths
	 */
	public TotalStatsResponse(String total_cases, String total_deaths, String total_recovered, String new_cases,
			String new_deaths) {
		super();
		this.total_cases = total_cases;
		this.total_deaths = total_deaths;
	...
	public String toString() {
		return "TotalStatsResponse [total_cases=" + total_cases + ", total_deaths=" + total_deaths
				+ ", total_recovered=" + total_recovered + ", new_cases=" + new_cases + ", new_deaths=" + new_deaths
				+ "]";
	}
